...
{
    //printBoards
    public Space[][] player1SelfBoard = new Space[8][8];
    public Space[][] player1opponentBoard = new Space[8][8];
    public Space[][] player2SelfBoard = new Space[8][8];
    public Space[][] player2opponentBoard = new Space[8][8];
